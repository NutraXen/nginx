...
#TEMP#echo sudo apt-get install -y lua5.1 liblua5.1-0 liblua5.1-0-dev luarocks
#TEMP#echo echo ""
...
cd /usr/share/nginx/GeoIP/
gunzip *gz
echo ""

# Copy timezone File
cp /usr/share/nginx/etc-config/timezone.conf /etc/nginx/
